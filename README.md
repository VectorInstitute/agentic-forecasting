...
- **Optional demos:** `playground/energy_yfinance/` and `playground/energy_case_study/` for energy/oil exploration and the May 21 information-session narrative notebook.
