"""Tests for the LiteLLM call seam in ``aieng.forecasting.methods.llm_processes._client``.
...
async def test_proxy_path_prefixes_model_with_openai() -> None:
    """With api_base set, the model is prefixed with 'openai/' before calling litellm."""
    captured: list[dict] = []
